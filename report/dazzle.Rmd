...
Here is a key formula that the reader should know about:
...
<details>
<summary> Analysts might want to view this information to confirm the correct data was used. </summary>
```{r}
print(analyst_info)
```
</details>
